...
- **Cloud Run Deployment**: Bundles the Vite frontend and Express API into a single, scalable Node.js container.
...
Deploy seamlessly to Google Cloud Run from the `applet` directory:
```bash
